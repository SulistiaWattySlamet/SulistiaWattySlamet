                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="Data_Kategori_Menu.php">Data
                                        Kategori Menu</a></li>
                                <li class="nav-item"> <a class="nav-link" href="pages/Data Master/Data_Menu.php">Data
                                        Menu</a></li>
                                <li class="nav-item"> <a class="nav-link" href="pages/Data Master/Data_Harga.php">Data
                                        Harga</a></li>
                                <li class="nav-item"> <a class="nav-link" href="pages/Data Master/Stok_Menu.php">Data
                                        Stok Menu</a></li>
                                <li class="nav-item"> <a class="nav-link" href="Data_User.php">Data
                                        User</a></li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="p_add_data_kategori.php">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Kategori</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama Kategori" name="nama">
                                        </div>
                                        <div class="form-group">
