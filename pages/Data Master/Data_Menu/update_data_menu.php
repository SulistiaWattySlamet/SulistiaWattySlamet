...
// }
$id_menu = $_GET['name'];
// $sql = "SELECT a.*,b.*,a.id as id_menu FROM menu a INNER JOIN kategori_menu b on a.id_kategori=b.id order by a.id=$username asc";
...
echo "dataku: " . $id_menu . $nama_menu . $gambar . $keterangan;
?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post"
                                        action="p_update_data_menu.php?pg=kategori&act=edit"
                                        enctype="multipart/form-data">
                                        <div><input type="hidden" name="id_menu" value="<?php echo $id_menu; ?>"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <a class="cboxElement ">
                                                    <?php echo " <img src='../../../upload/menu/" . $gambar . "' id='uploadPreview1' width='120' height='140'/>"; ?>
                                                </a>
