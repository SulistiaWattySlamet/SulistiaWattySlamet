                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="Data_Menu.php">Data
                                        Menu</a></li>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="p_add_data_menu.php?pg=kategori&act=edit" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nama Menu</label>
                                                <input type="text" class="form-control" id="exampleInputUsername1" name="nama_menu" placeholder="Nama Menu">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Foto
                                                    Menu</label> <br>
                                                <a class="cboxElement ">
                                                    <?php echo " <img src='../../../upload/menu/' id='uploadPreview1' width='120' height='140'/>"; ?>
                                                </a>
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="update" value=1>Submit</button>
                                            <a href="Data_Menu.php" class="btn btn-light" hr>Cancel</a>
