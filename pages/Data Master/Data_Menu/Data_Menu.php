                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title">
                                        <a class="btn btn-outline-primary btn-icon-text" href="add_data_menu.php">Tambah
                                            Data</a>
                                        Daftar Menu di Cafe Puncak Kelapa Dua
                                    </p>
                                    <!-- add_data_ -->
                                            ...
                                            <div class="table-responsive">
                                                <form action="POST">
                                                    <table id="dataTable" class="display expandable-table"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $tampil = $mysqli->query("SELECT * FROM menu ");
                                                            $no = 1;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo "<img src=../../../upload/menu/" . $r['gambar'] . " width='60px'>"; ?>
                                                                </td>
                                                                </td>
                                                                <td><?php echo "$r[ket]" ?></td>
                                                                <td>
                                                                    <a class="btn btn-outline-danger btn-icon-text"
                                                                        href="delete_data_menu.php?name=<?php echo $r['id']; ?>"
                                                                        onclick="return confirm('Anda yakin hapus ?')">Delete</a>
                                                                    <a class="btn btn-outline-secondary btn-icon-text"
                                                                        href="update_data_menu.php?name=<?php echo $r['id']; ?>">Update</a>
                                                                </td>
                                                            </tr>
                                                            <?php $no++;
                                                            } ?>
