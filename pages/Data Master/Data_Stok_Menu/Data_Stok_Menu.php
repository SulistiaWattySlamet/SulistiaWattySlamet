                                            ...
                                            <div class="table-responsive">
                                                <form method="POST">
                                                    <table id="dataTable" class="display expandable-table" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql = "SELECT a.*,a.id as id_menu ,b.*, b.id as id_stok
                                                            FROM menu a 
                                                            INNER JOIN stok b ON a.id=b.id_menu";
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a class="btn btn-outline-secondary btn-icon-text" href="update_stok.php?id_stok=<?php echo $r['id_stok']; ?>&nama=<?php echo $r['nama_menu']; ?>&stok=<?php echo $r['stok']; ?>&sisa=<?php echo $r['sisa']; ?>">Update</a>
                                                                    </td>
                                                                </tr>
                                                            <?php $no++;
                                                            } ?>
