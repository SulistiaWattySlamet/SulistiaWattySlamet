                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="p_update_stok.php">
                                        <input type="hidden" name="id_stok" value="<?php echo $id_stok ?>">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Menu</label>
                                            <input disabled type="text" class="form-control" id="exampleInputUsername1"
                                                value="<?php echo $nama ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Stok</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1"
                                                name="stok" placeholder="Rp. " value="<?php echo $stok ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Sisa</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1"
                                                name="sisa" placeholder="Rp. " value="<?php echo $sisa ?>">
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2">Submit</button>
                                        <a href="Data_Stok_Menu.php" class="btn btn-light" hr>Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
