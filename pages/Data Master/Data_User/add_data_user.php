                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="p_add_data_user.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nama</label>
                                                <input type="text" class="form-control" id="exampleInputUsername1" name="nama" placeholder="Nama User">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Hak Ases</label>
                                                <select id='level_user' name='level_user' class="form-control select2" data-validation="[NOTEMPTY]">
