                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title">
                                        <a class="btn btn-outline-primary btn-icon-text" href="add_data_user.php">Tambah
                                            Data</a>
                                        List User Terdaftar di Cafe Puncak Kelapa Dua
                                    </p>
                                    <!-- add_data_ -->
                                            ...
                                            <div class="table-responsive">
                                                <form action="POST">
                                                    <table id="dataTable" class="display expandable-table" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $tampil = $mysqli->query("SELECT * FROM users ");
                                                            $no = 1;
                                                            $leveluser = "";
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php
                                                                        if ($r['level_user'] == 1) {
                                                                            $leveluser = "admin";
                                                                        } else if ($r['level_user'] == 2) {
                                                                            $leveluser = "pimpinan";
                                                                        } else if ($r['level_user'] == 3) {
                                                                            $leveluser = "kasir";
                                                                        } else if ($r['level_user'] == 4) {
                                                                            $leveluser = "customer";
                                                                        } else {
                                                                        ...
                                                                        echo "$leveluser" ?></td>
                                                                    <td>
                                                                        <a class="btn btn-outline-danger btn-icon-text" href="delete_data_user.php?iduser=<?php echo $r['idusers']; ?>" onclick="return confirm('Anda yakin hapus ?')">Delete</a>
                                                                        <a class="btn btn-outline-secondary btn-icon-text" href="update_data_user.php?iduser=<?php echo $r['idusers']; ?>">Update</a>
                                                                    </td>
                                                                </tr>
                                                            <?php $no++;
                                                            } ?>
