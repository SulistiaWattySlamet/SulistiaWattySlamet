                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="p_update_data_harga.php">
                                        <input type="hidden" name="id_harga" value="<?php echo $id_harga ?>">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Menu</label>
                                            <input disabled type="text" class="form-control" id="exampleInputUsername1" value="<?php echo $nama ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Harga</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1" name="harga" placeholder="Rp. " value="<?php echo $harga ?>">
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2">Submit</button>
                                        <a href="Data_Harga.php" class="btn btn-light" hr>Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
