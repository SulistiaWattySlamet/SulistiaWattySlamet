                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <a class="dropdown-item" href="../../../pages/Login/login.php">
                ...
                <ul class="nav">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="../Data_Harga/Data_Harga.php">Data
                                        Harga</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../Data_Stok_Menu/Data_Stok_Menu.php">Data
                                        Stok Menu</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Pemesanan
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Pembayaran
                                    </a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="charts">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="pages/charts/chartjs.html">Pembayaran</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title">
                                        <a class="btn btn-outline-primary btn-icon-text" href="add_data_kategori.php">Tambah Data</a>
                                        Kategori Menu
                                    </p>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo "$r[ket_kategori]" ?></td>
                                                                    <td>
                                                                        <a class="btn btn-outline-danger btn-icon-text" href="delete_data_kategori.php?name=<?php echo $r['nama_kategori']; ?>" onclick="return confirm('Anda yakin hapus ?')">Delete</a>
                                                                        <a class="btn btn-outline-secondary btn-icon-text" href="update_data_kategori.php?name=<?php echo $r['nama_kategori']; ?>">Update</a>
                                                                    </td>
                                                                </tr>
                                                            <?php $no++;
                                                            } ?>
